...
<%
    ...
    List<Master> masters = (List<Master>) request.getAttribute("masters");
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 mb-5">
                    ...
                    <form action="/addApointment" method="post" class="p-5 bg-white">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="surname" id="lname" class="form-control"
                        ...
                        <div class="row form-group">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <input type="date" name="date" class="form-control" placeholder="Date of visit">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <input type="time" name="time" class="form-control" placeholder="Time of visit">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <select name="serviseID" id="treatment" class="form-control">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <label class="text-black" for="treatment">Master You Want</label>
                                <select name="masterID" class="form-control">
                                    <%for (Master master : masters) {%>
                                    <option value="<%=master.getId()%>"><%=master.getName()%>
                                    </option>
                                    <%}%>>
                                </select>
